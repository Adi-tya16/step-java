...
public class SmartDevice {
    ...
    public static void main(String[] args) {
        ...
        SmartDevice device1 = new SmartDevice("Smart Bulb", "Living Room", false, 15.5);
        SmartDevice device2 = new SmartDevice("Smart Speaker", "Bedroom", true, 10.0);

        device1.setOnline(true).connectToDevice("Smart Speaker").rename("Living Room Bulb");
        device1.updateLocation("Dining Room");
        device1.updatePowerConsumption(20.0);
        device1.displayDeviceInfo();

        device2.performInitialSetup();
        device2.connectToDevice("Smart Bulb").rename("Bedroom Speaker");
